      ...
      <div className="container px-10">
        <div className="flex flex-col items-center justify-center md:flex-row md:items-start md:justify-between">
          <div className="w-full md:w-1/2 lg:w-3/4 text-left text-white">
            ...
            <h1 className="text-4xl text-[#0b7bff] font-semibold mb-4 md:text-5xl lg:text-6xl">
              Gautam Paranjape
            </h1>
          ...
          <div className="w-full flex justify-center items-center md:w-1/2 lg:w-1/4 md:pl-8">
            <img
